...
public class ReporteProductosMenosVendidos extends Reporte {
    private Producto[] productos;
    private int totalProductos;
    private Pedido[] pedidos;
    private int totalPedidos;

    public ReporteProductosMenosVendidos(Producto[] productos, int totalProductos, Pedido[] pedidos, int totalPedidos) {
        super("Top 5 Productos Menos Vendidos");
    ...
    public String generarContenido() {
        ...
        for (int i = 0; i < limite; i++) {
            contenido.append((i + 1)).append(". ").append(productosOrdenados[i].getNombre())
                    ...
                    .append("\n   Stock actual: ").append(productosOrdenados[i].getStock())
                    .append("\n   Recomendacion: Promocionar producto")
                    .append("\n\n");
        }
